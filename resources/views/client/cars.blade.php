...
@section('contenu')
    ...
    <div class="container-fluid page-header">
        ...
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase m-0"><a class="text-white" href="">Voir tout</a></h6>
            <h6 class="text-body m-0 px-3">/</h6>
            <a href="#"><h6 class="text-uppercase text-body m-0">Mercedes Bens</h6></a>
            <a href="#"><h6 class="text-uppercase text-body m-0">Toyata</h6></a>
            <a href="#"><h6 class="text-uppercase text-body m-0">Opel</h6></a>
