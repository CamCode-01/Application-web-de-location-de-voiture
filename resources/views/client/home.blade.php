            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-1 text-white mb-md-4">meilleur site de location de voitures</h1>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">CamCars</h4>
                            <h1 class="display-1 text-white mb-md-4">Profiter de nos offres promotionnel</h1>
                            <a href="" class="btn btn-primary py-md-3 px-md-5 mt-2">Reserver maintenant</a>
                        </div>
                    </div>
                </div>
